...
settings = dict(
    ...
    machine_organization_name   = environ.get('MACHINE_ORGANIZATION_NAME', 'questioning-machine'),
    private_repo_with_text      = environ.get('PRIVATE_REPO_WITH_TEXT','questioning_machine'),
